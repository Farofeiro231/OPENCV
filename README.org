...
The barebones of the program, including the algorithm to create the "dotted" image was provided by the professor, and it was asked for us to implement an improved version of the dotillism effect by making use of the Canny edges.
