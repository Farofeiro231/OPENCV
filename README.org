...
The modified program, built on top of that one, has kept the origiannl sliders simply for the user to be able to see the old effect applied to the image; however, it has added functionnalities to produce the tilt-shift effect.
