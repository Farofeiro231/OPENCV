...
A few more steps are necessary to plot the histogram graphs on top of the equalized image. First, I had to normalize each histogram to fit the size of the small plotting windows where it will be plotted. Here's how it's done:
